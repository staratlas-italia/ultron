...
export class SageFleet {
  ...
  async ixStopMining() {
    ...
    const ix_0 = Fleet.asteroidMiningHandler(
      ...
      this.fleet.data.cargoHold,
      this.fleet.data.ammoBank,
      this.getSageGame().getCargoTypeByResourceName("Food"),
      this.getSageGame().getCargoTypeByResourceName("Ammo"),
    ...
    const ix_1 = Fleet.stopMiningAsteroid(
      ...
      planetKey,
      this.fleet.data.fuelTank,
      this.getSageGame().getCargoTypeByResourceName("Fuel"),
      this.getSageGame().getCargoStatsDefinition().key,
  ...
  async ixWarpToSector(sector: SectorRoute, fuelNeeded: BN) {
    ...
    const fuelMint = this.getSageGame().getResourceMintByName("Fuel");
  ...
  async ixScanForSurveyDataUnits() {
    ...
    const foodMint = this.getSageGame().getResourceMintByName("Food");
    const sduMint = this.getSageGame().getResourceMintByName("Sdu");
    ...
    const ix_0 = SurveyDataUnitTracker.scanForSurveyDataUnits(
      ...
      cargoHold.key,
      this.getSageGame().getCargoTypeByResourceName("Sdu"),
      this.getSageGame().getCargoTypeByResourceName("Food"),
      this.getSageGame().getCargoStatsDefinition().key,
      sduTokenFrom,
      ixSduTokenTo.address,
