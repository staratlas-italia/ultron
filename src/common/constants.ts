...
export const activites = ["Mining", "Cargo", "Combo", "Scan", "Craft"] as const;
export type Activity = (typeof activites)[number];

export const movements = ["Warp", "Subwarp"] as const;
export type MovementType = (typeof movements)[number];

export const priorities = ["default", "low", "medium", "high", "none"] as const;

export type PriorityLevel = (typeof priorities)[number];

export type PriorityFee =
  | {
      type: Exclude<PriorityLevel, "custom">;
    }
